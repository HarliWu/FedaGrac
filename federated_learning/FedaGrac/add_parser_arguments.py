...
def new_arguements(parser: ArgumentParser):
    ...
    parser.add_argument('--lam', type=float, default=0.03, help='hyperparameter for calibration')
    # parser.add_argument('--beta', type=float, default=1.0, help='hyperparameter for local calibration')
    ...
    parser.add_argument('--avg_k', type=int, default=-1, help='average number of local iterations')
